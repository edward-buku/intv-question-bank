...
class FlameGraphAnalyzer {
    ...
    public static void main(String[] args) {
        provideSolution(makeTestCase1());
        provideSolution(makeTestCase2());
        provideSolution(makeTestCase3());
        provideSolution(makeTestCase4());
        provideSolution(makeTestCase5());
        provideSolution(makeTestCase6());
        provideSolution(makeTestCase7());
    }
    
    private static void provideSolution(List<FlameBar> graph) {
